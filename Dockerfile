...
# Default to upstream main so builds do not fail when a pinned tag is removed/renamed; override with --build-arg HERMES_REF=<tag-or-sha> for deterministic deployments.
